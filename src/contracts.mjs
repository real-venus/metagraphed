...
export const PUBLIC_ARTIFACTS = [
  ...
  artifact(
    ...
    "Network registration/population census across all subnets' neurons: neuron/subnet counts, the active/immunity/validator/miner split and rates, and the registration-age distribution (blocks since registration) — the population companion to chain-performance/chain-concentration/chain-turnover, computed live from the neurons D1 tier at /api/v1/chain/census (no static file).",
    "ChainCensusArtifact",
  ),
  artifact(
    "chain-turnover",
